...
const EditList = () => {
    ...
    // here we can use useEffect hook to fetch the list for editing and updating
    // useEffect(() => {
    //     setLoading(true);

    //     const fetchList = async () => {

    //         const docReference = doc(database, "RealtorCloneListing", params.listingId);
    ...
    useEffect(() => {
        try {
            if (list && list.userRef !== auth.currentUser.uid) {
                ...
                navigate("/");
                console.log(list, list.userRef);
            }
        } catch (error) {
            console.log(error.message);
            alert(error.message);
        }
    }, [list, auth.currentUser.uid, navigate]);
    ...
    useEffect(() => {
        ...
        async function fetchListing() {
            setLoading(true);
            const docRef = collection(database, "RealtorCloneListing", params.listingId);
